...
async function syncdb() {
  let thumbnailImagePath = __dirname + "/assets/botx.jpeg";
  ...
  try {
    ...
    thumbnailImagePath = __dirname + "/assets/botx.jpeg";
  }
  global.log0 =
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x1f88ec =
        ...
        Config.WORKTYPE +
        "\n  Database: " +
        (isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "QUEEN_ALYA") +
        "\n";
      try {
